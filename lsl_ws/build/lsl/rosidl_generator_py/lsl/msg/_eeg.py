...
class Metaclass_Eeg(type):
    """Metaclass of message 'Eeg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('lsl')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__eeg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__eeg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__eeg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__eeg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__eeg
...
class Eeg(metaclass=Metaclass_Eeg):
    """Message class 'Eeg'."""
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'channel_names' field must be a set or sequence and each value of type 'str'"
